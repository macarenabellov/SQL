1)	First, I’d like to show our volumen growth. Can you pull overall session and order volumen, trended by quarter for the life of the business? Since the most recent quarter is incomplete, you can decide how to handle it.
SELECT
...
5)	We’ve come a long way since the days of selling a single product. Let’s pul monthly trending for revenue and margin by product, along with total sales and revenue. Note anything you notice about seasonality.
SELECT
