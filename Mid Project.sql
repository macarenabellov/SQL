...
5)	Could you pull session to order conversion rates, by month? I’d like to tell the story of our website performance improvements over the course of the first 8 months.
...
7)	For the landing page test you analyzed previously, please show a full conversion funnel from earch of the two pages to orders. It can be used the same time period (Jun 19 – Jul 28)
